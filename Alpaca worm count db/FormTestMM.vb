...
Public Class FormTest
    ...
    Private Sub UpdateDb()
        ...
        Dim testDate As String = System.TimeZoneInfo.ConvertTime(DateTimePicker1.Value, TimeZoneInfo.FindSystemTimeZoneById("GMT Standard Time"))

        drow.Item(1) = testDate
        ...
        drow.Item(8) = NumericUpDown1.Value.ToString("000.##") & NumericUpDown13.Value.ToString("000.##")
        drow.Item(9) = NumericUpDown2.Value.ToString("000.##") & NumericUpDown14.Value.ToString("000.##")
        drow.Item(10) = NumericUpDown3.Value.ToString("000.##") & NumericUpDown15.Value.ToString("000.##")
        drow.Item(11) = NumericUpDown4.Value.ToString("000.##") & NumericUpDown16.Value.ToString("000.##")
        drow.Item(12) = NumericUpDown5.Value.ToString("000.##") & NumericUpDown17.Value.ToString("000.##")
        drow.Item(13) = NumericUpDown6.Value.ToString("000.##") & NumericUpDown18.Value.ToString("000.##")
        drow.Item(14) = NumericUpDown7.Value.ToString("000.##") & NumericUpDown19.Value.ToString("000.##")
        drow.Item(15) = NumericUpDown8.Value.ToString("000.##") & NumericUpDown20.Value.ToString("000.##")
        drow.Item(16) = NumericUpDown9.Value.ToString("000.##") & NumericUpDown21.Value.ToString("000.##")
        drow.Item(17) = NumericUpDown10.Value.ToString("000.##") & NumericUpDown22.Value.ToString("000.##")
        drow.Item(18) = NumericUpDown11.Value.ToString("000.##") & NumericUpDown23.Value.ToString("000.##")
        drow.Item(19) = NumericUpDown12.Value.ToString("000.##") & NumericUpDown24.Value.ToString("000.##")
        drow.Item(20) = "No Treatment"
        drow.Item(21) = "MM"
        drow.Item(24) = Convert.ToInt64(Label67.Text) + Convert.ToInt64(Label66.Text)
